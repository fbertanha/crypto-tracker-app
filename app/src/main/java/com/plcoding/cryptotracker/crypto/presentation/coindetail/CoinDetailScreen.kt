...
import com.plcoding.cryptotracker.crypto.presentation.coindetail.chart.ChartStyle
import com.plcoding.cryptotracker.crypto.presentation.coindetail.chart.DataPoint
import com.plcoding.cryptotracker.crypto.presentation.coindetail.chart.LineChart
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            AnimatedVisibility(visible = coin.history.isNotEmpty()) {
                ...
                val startIndex =
                    (coin.history.lastIndex - amountOfVisibleDataPoints).coerceAtLeast(0)

                println("startIndex=${startIndex} last=${coin.history.indices.last}")
                LineChart(dataPoints = coin.history,
                    ...
                    visibleDataPointsIndices = startIndex..coin.history.lastIndex,
                    unit = "$",
                    modifier = Modifier
                        .fillMaxWidth()
                        .aspectRatio(16 / 9f)
